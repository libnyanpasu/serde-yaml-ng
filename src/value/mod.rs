...
/// }
///
/// # fn try_main() -> Result<(), serde_yaml_ng::Error> {
/// let data = r#" { "level": 42 } "#;
/// let s: Settings = serde_yaml_ng::from_str(data)?;
///
...
/// A YAML sequence in which the elements are `serde_yaml_ng::Value`.
pub type Sequence = Vec<Value>;

/// Convert a `T` into `serde_yaml_ng::Value` which is an enum that can represent
/// any valid YAML data.
///
...
/// ```
/// # use serde_yaml_ng::Value;
/// let val = serde_yaml_ng::to_value("s").unwrap();
...
/// Interpret a `serde_yaml_ng::Value` as an instance of type `T`.
///
...
/// let s: String = serde_yaml_ng::from_value(val).unwrap();
/// assert_eq!("foo", s);
/// ```
...
impl Value {
    ...
    /// use serde_yaml_ng::Value;
    ///
    /// let object: Value = serde_yaml_ng::from_str(r#"{ A: 65, B: 66, C: 67 }"#)?;
    /// let x = object.get("A").unwrap();
    /// assert_eq!(x, 65);
    ///
    /// let sequence: Value = serde_yaml_ng::from_str(r#"[ "A", "B", "C" ]"#)?;
    ...
    /// #
    /// # fn main() -> serde_yaml_ng::Result<()> {
    /// let object: Value = serde_yaml_ng::from_str(r#"
    /// A: [a, á, à]
    /// B: [b, b́]
    /// C: [c, ć, ć̣, ḉ]
    /// 42: true
    ...
    /// ```
    /// # use serde_yaml_ng::Value;
    /// let v: Value = serde_yaml_ng::from_str("null").unwrap();
    /// assert!(v.is_null());
    /// ```
    ///
    /// ```
    /// # use serde_yaml_ng::Value;
    /// let v: Value = serde_yaml_ng::from_str("false").unwrap();
    /// assert!(!v.is_null());
    /// ```
    ...
    /// ```
    /// # use serde_yaml_ng::Value;
    /// let v: Value = serde_yaml_ng::from_str("true").unwrap();
    /// assert!(v.is_bool());
    /// ```
    ///
    /// ```
    /// # use serde_yaml_ng::Value;
    /// let v: Value = serde_yaml_ng::from_str("42").unwrap();
    /// assert!(!v.is_bool());
    /// ```
    ...
    /// ```
    /// # use serde_yaml_ng::Value;
    /// let v: Value = serde_yaml_ng::from_str("5").unwrap();
    /// assert!(v.is_number());
    /// ```
    ///
    /// ```
    ...
    /// ```
    /// # use serde_yaml_ng::Value;
    /// let v: Value = serde_yaml_ng::from_str("1337").unwrap();
    /// assert!(v.is_i64());
    /// ```
    ///
    /// ```
    ...
    /// ```
    /// # use serde_yaml_ng::Value;
    /// let v: Value = serde_yaml_ng::from_str("256.01").unwrap();
    /// assert!(v.is_f64());
    /// ```
    ///
    /// ```
    ...
    /// ```
    /// # use serde_yaml_ng::Value;
    /// let v: Value = serde_yaml_ng::from_str("13.37").unwrap();
    ...
    /// ```
    /// # use serde_yaml_ng::Value;
    /// let v: Value = serde_yaml_ng::from_str("'lorem ipsum'").unwrap();
    /// assert!(v.is_string());
    /// ```
    ///
    /// ```
    ...
    /// ```
    /// # use serde_yaml_ng::Value;
    /// let v: Value = serde_yaml_ng::from_str("[1, 2, 3]").unwrap();
    ...
    ///
    /// ```
    /// # use serde_yaml_ng::{Value, Number};
    /// let v: Value = serde_yaml_ng::from_str("[1, 2]").unwrap();
    ...
    /// ```
    /// # use serde_yaml_ng::{Value, Number};
    /// let mut v: Value = serde_yaml_ng::from_str("[1]").unwrap();
    ...
    /// ```
    /// # use serde_yaml_ng::Value;
    /// let mut v: Value = serde_yaml_ng::from_str("false").unwrap();
    ...
    /// ```
    /// # use serde_yaml_ng::Value;
    /// let v: Value = serde_yaml_ng::from_str("a: 42").unwrap();
    /// assert!(v.is_mapping());
    /// ```
    ///
    /// ```
    ...
    ///
    /// ```
    /// # use serde_yaml_ng::{Value, Mapping, Number};
    /// let v: Value = serde_yaml_ng::from_str("a: 42").unwrap();
    ///
    ...
    /// ```
    /// # use serde_yaml_ng::{Value, Mapping, Number};
    /// let mut v: Value = serde_yaml_ng::from_str("a: 42").unwrap();
    ...
    /// ";
    ///
    /// let mut value: Value = serde_yaml_ng::from_str(config).unwrap();
